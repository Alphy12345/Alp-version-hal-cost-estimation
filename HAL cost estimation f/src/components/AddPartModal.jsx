        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div className="space-y-4">
            <div className="flex flex-col gap-1">
              ...
              {model3d && (
                <div className="flex items-center justify-between bg-slate-50 px-3 py-2 rounded-lg border border-slate-200">
                  <span className="text-sm text-slate-600 truncate">{model3d.name}</span>
                  <button
                    type="button"
              ...
              {!model3d && partToEdit?.model_3d_path && (
                <p className="text-xs text-slate-500">Current file: {partToEdit.model_3d_path.split('\\').pop()}</p>
              )}
            </div>
            ...
            <div className="flex flex-col gap-1">
              ...
              {drawing2d && (
                <div className="flex items-center justify-between bg-slate-50 px-3 py-2 rounded-lg border border-slate-200">
                  <span className="text-sm text-slate-600 truncate">{drawing2d.name}</span>
                  <button
                    type="button"
              ...
              {!drawing2d && partToEdit?.drawing_2d_path && (
                <p className="text-xs text-slate-500">Current file: {partToEdit.drawing_2d_path.split('\\').pop()}</p>
              )}
            </div>
          </div>
